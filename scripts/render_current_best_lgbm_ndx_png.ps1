...
$source = Join-Path $root 'reports\current_best_lgbm_vs_ndx_2020_2026.csv'
$metricsPath = Join-Path $root 'data\current_best_lgbm_vs_ndx_2020_2026.json'
$output = Join-Path $root 'reports\current_best_lgbm_vs_ndx_2020_2026.png'
...
$graphics.DrawString('Current best LGBM vs Nasdaq-100, 2020-2026', $titleFont, $foregroundBrush, $left, 23)
...
$summary = 'CAGR: LGBM {0:P2} | NDX {1:P2}' -f $metrics.strategy.metrics.annual_return, $metrics.nasdaq_100.metrics.annual_return
