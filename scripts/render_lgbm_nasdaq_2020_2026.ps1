...
$csvPath = Join-Path $baseDir "reports\lgbm_vs_nasdaq_2020_2026.csv"
$jsonPath = Join-Path $baseDir "reports\lgbm_vs_nasdaq_2020_2026.json"
$pngPath = Join-Path $baseDir "reports\lgbm_vs_nasdaq_2020_2026.png"
...
$subtitle.Text = "LGBM $($lgbmReturn.ToString('+0.0%;-0.0%'))    Nasdaq $($nasdaqReturn.ToString('+0.0%;-0.0%'))    |    monthly expanding refits; next-open; 12bp one-way cost"
